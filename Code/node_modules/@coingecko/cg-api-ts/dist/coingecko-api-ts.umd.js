(function (global, factory) {
    ...
    (global = global || self, factory(global['coingecko-api-ts'] = {}));
    ...
    ***************************************************************************** */
    ...
    })(exports.RootAPI || (exports.RootAPI = {}));
    (function (APIError) {
        APIError["DOWN"] = "DOWN";
        APIError["SERVER"] = "SERVER";
        APIError["TIMEOUT"] = "TIMEOUT";
        APIError["UNAUTHORIZED"] = "UNAUTHORIZED";
    })(exports.APIError || (exports.APIError = {}));
    ...
    })(exports.CoinsMarketsSortOrder || (exports.CoinsMarketsSortOrder = {}));
    ...
    })(exports.TickerSortOrder || (exports.TickerSortOrder = {}));
    ...
    })(exports.PriceChangePercentage || (exports.PriceChangePercentage = {}));
    ...
    })(exports.BeamFilterCategories || (exports.BeamFilterCategories = {}));
    ...
    })(exports.BeamFilterProjectType || (exports.BeamFilterProjectType = {}));
    ...
    })(exports.DerivativesExchangesSortType || (exports.DerivativesExchangesSortType = {}));
    ...
    })(exports.DerivativesExchangeTickerType || (exports.DerivativesExchangeTickerType = {}));
    ...
    const timeoutWrapper = (ms, promise) => {
        return new Promise((resolve, reject) => {
            setTimeout(() => {
                reject(new CGError(exports.APIError.TIMEOUT, null, `Request timeout after ${ms}ms`));
            }, ms);
    ...
    const handleError = (response) => {
        if (response.status >= 500 && response.status <= 530) {
            throw new CGError(exports.APIError.DOWN, response, "CoinGecko API down");
        }
        else if (!response.ok && response.status === 401) {
            throw new CGError(exports.APIError.UNAUTHORIZED, response, response.statusText);
        }
        else if (!response.ok) {
            throw new CGError(exports.APIError.SERVER, response, response.statusText);
        }
        return response;
    };

    class CoinGeckoAPI {
        constructor(fetch, timeout = 20000, baseUrl = exports.RootAPI.PROD, getHeader = {}, postHeader = {}) {
            this.fetch = fetch;
        ...
        getCoinsMarket(vsCurrency, order = exports.CoinsMarketsSortOrder.MARKET_CAP_DESC, ids = [], perPage = 100, page = 1, sparkline = false, priceChangePercentage = []) {
            if (perPage &&
        ...
        getCoinsIdTickers(id, includeExchangeLogo = true, page = 1, order = exports.TickerSortOrder.TRUST_SCORE_DESC, exchangesIds = []) {
            const encodedUrl = urlEncode({
        ...
        getCoinsLite(vsCurrency = "usd", categoryId = "cryptocurrency", locale = "en", page = 1, perPage = 20, order = exports.SortOrder.MARKET_CAP_DESCENDING) {
            const encodedUrl = urlEncode({
                vs_currency: vsCurrency,
        ...
        getExchangesIdTicker(id, coinIds = [], exchangeLogo = true, page = 0, order = exports.TickerSortOrder.TRUST_SCORE_DESC) {
            const encodedUrl = urlEncode({
         ...
         */
        getDerivativesExchanges(order = exports.DerivativesExchangesSortType.OPEN_INTEREST_BTC_DESC) {
         ...
         */
        getDerivativesExchangesId(id, includeTickers = exports.DerivativesExchangeTickerType.NONE) {
            const encodedUrl = includeTickers !== exports.DerivativesExchangeTickerType.NONE
         ...
         */
        getStatusUpdates(page, category = exports.BeamFilterCategories.ALL_CATEGORIES, project = exports.BeamFilterProjectType.ALL, perPage = 10) {
            const encodedUrl = urlEncode({
                page,
                category,
...
//# sourceMappingURL=coingecko-api-ts.umd.js.map
